...
public class GenerarReporte {
    ...
    public static void exportar(String sRutaDirectorioJasper,Map parametros,List listaBeans,String formato,boolean maps,String nombreArchivo) throws JRException {
...
//  Exportar documentos en DOCX : SimpleDocxReportConfiguration
        ...
        reporte.setParameter(JRExporterParameter.OUTPUT_FILE, new File(nombreArchivo));
